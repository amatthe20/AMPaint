...
public class HelpMenu {
    ...
    public void about() {             // About
        ...
        about.getChildren().add(new Text("Welcome to AMPaint!\n" // user can learn about the app and see the version
                ...
                + "NEW LAYOUT - ToolBar is on the right side of canvas\n\n"
                + "Features:\n\n" + "Import Image as Canvas\n" + "Save Canvas in Application\n"
                + "Save Canvas to Computer\n" + "Keyboard Shortcuts for the File, Edit, Tools, and Shapes Menus\n"
                + "Tabs (open multiple canvases at once)\n" + "Pencil and Line Tools\n"
                + "Square, Rectangle, Circle, Ellipse, Triangle, and Custom Shapes\n" + "Smart Save\n"
                + "ToolBar for Tabs, Thickness, Color, Eraser, Clearing Canvas, Color Grabber, and Resizing\n" + "Dark Mode\n"
